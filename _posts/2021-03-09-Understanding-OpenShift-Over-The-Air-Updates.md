...
# ⭐ BLOG TODO ⭐ Everything Below Is Scratch Notes

{% highlight shell %}
oc get mc/00-worker -o json | jq .spec.osImageURL
"quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:4c5b83a192734ad6aa33da798f51b4b7ebe0f633ed63d53867a0c3fb73993024"
{% endhighlight %}

This can be seen on the node:
...
* Immutable management by MCO through Kube API
* Installing RPMs on RHCOS is not supported. Should run as container.
* /etc, /boot, and /var may be modified by MachineConfigs
* Files may be written to /usr/local which is a symlink to /var/usrlocal but it is not recommended.
* Container image is pulled. OS content is extracted. Boot loader is updated using `rpm-ostree`. Machine reboots.
* https://gitlab.cee.redhat.com/coreos/redhat-coreos/-/blob/master/docs/build-process.md
** https://github.com/openshift/machine-config-operator/blob/master/docs/OSUpgrades.md[ostree repo inside container]
* https://github.com/openshift/cluster-version-operator/blob/master/docs/dev/upgrades.md

{% highlight bash %}
$ oc debug node/<foo>
sh-4.4# chroot /host
sh-4.4# systemctl cat rpm-ostreed
{% endhighlight %}
{% highlight ini %}
...
# /etc/systemd/system/rpm-ostreed.service.d/mco-controlplane-nice.conf
...
{% highlight shell %}
I0209 18:01:46.012891    5055 daemon.go:815] Current config: rendered-master-6d4912fce0adfd7214251f36ffe6a0ca
  osImageURL: quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:4c5b83a192734ad6aa33da798f51b4b7ebe0f633ed63d53867a0c3fb73993024
I0209 18:01:46.012945    5055 daemon.go:816] Desired config: rendered-master-ff38f849e21009792e7db36fe2c27ef9
  osImageURL: quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d2076221081a81b6c92fbecfd044ef160161e


oc get pods -o wide -n openshift-machine-config-operator |grep master-1
machine-config-daemon-9hx9j                  2/2     Running   0          3d19h   192.168.4.63    vipi-7zc6h-master-1       <none>           <none>
machine-config-server-spgk8                  1/1     Running   0          3d19h   192.168.4.63    vipi-7zc6h-master-1       <none>           <none>
...
sh-4.4# /run/bin/machine-config-daemon pivot quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d207622108
1a81b6c92fbecfd044ef160161e
I0209 18:25:14.080598  141927 run.go:18] Running: nice -- ionice -c 3 oc image extract --path /:/run/mco-machine-os-content/os-content-506958871 --registry-config /var/lib/kubelet/config.json quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d2076221081a81b6c92fbecfd044ef160161e
I0209 18:25:59.423481  141927 rpm-ostree.go:261] Running captured: rpm-ostree status --json
I0209 18:25:59.587981  141927 rpm-ostree.go:179] Previous pivot: quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:4c5b83a192734ad6aa33da798f51b4b7ebe0f633ed63d53867a0c3fb73993024
I0209 18:26:01.248067  141927 rpm-ostree.go:211] Pivoting to: 46.82.202101131942-0 (046de410ba240083996855d797207e09374bbfdf65e5be34baa1e1f1ab49918a)
I0209 18:26:01.248105  141927 rpm-ostree.go:243] Executing rebase from repo path /run/mco-machine-os-content/os-content-506958871/srv/repo with customImageURL pivot://quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d2076221081a81b6c92fbecfd044ef160161e and checksum 046de410ba240083996855d797207e09374bbfdf65e5be34baa1e1f1ab49918a
I0209 18:26:01.248121  141927 rpm-ostree.go:261] Running captured: rpm-ostree rebase --experimental /run/mco-machine-os-content/os-content-506958871/srv/repo:046de410ba240083996855d797207e09374bbfdf65e5be34baa1e1f1ab49918a --custom-origin-url pivot://quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d2076221081a81b6c92fbecfd044ef160161e --custom-origin-description Managed by machine-config-operator
  ...
  pivot://quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:6069ffcc5dcd227c867a86970f3d2076221081a81b6c92fbecfd044ef160161e
              CustomOrigin: Managed by machine-config-operator
                   Version: 46.82.202101131942-0 (2021-01-13T19:45:25Z)
                    ...
                    Staged: yes
                 StateRoot: rhcos
                  Upgraded: console-login-helper-messages 0.19-3.rhaos4.6.el8 -> 0.20.3-1.rhaos4.6.el8
                            console-login-helper-messages-issuegen 0.19-3.rhaos4.6.el8 -> 0.20.3-1.rhaos4.6.el8
                            console-login-helper-messages-profile 0.19-3.rhaos4.6.el8 -> 0.20.3-1.rhaos4.6.el8
                            cri-o 1.19.0-26.rhaos4.6.git8a05a29.el8 -> 1.19.1-2.rhaos4.6.git2af9ecf.el8
                            curl 7.61.1-12.el8 -> 7.61.1-12.el8_2.2
                            kernel 4.18.0-193.29.1.el8_2 -> 4.18.0-193.40.1.el8_2
                            kernel-core 4.18.0-193.29.1.el8_2 -> 4.18.0-193.40.1.el8_2
                            kernel-modules 4.18.0-193.29.1.el8_2 -> 4.18.0-193.40.1.el8_2
                            kernel-modules-extra 4.18.0-193.29.1.el8_2 -> 4.18.0-193.40.1.el8_2
                            libcurl 7.61.1-12.el8 -> 7.61.1-12.el8_2.2
                            openshift-clients 4.6.0-202011260456.p0.git.3798.fcf58ff.el8 -> 4.6.0-202012172338.p0.git.3800.30af700.el8
                            openshift-hyperkube 4.6.0-202012051246.p0.git.94231.efc9027.el8 -> 4.6.0-202012190744.p0.git.94235.c62c6f7.e
l8
                            openssl 1:1.1.1c-15.el8 -> 1:1.1.1c-16.el8_2
                            openssl-libs 1:1.1.1c-15.el8 -> 1:1.1.1c-16.el8_2
                            openvswitch2.13 2.13.0-71.el8fdp -> 2.13.0-72.el8fdp
                            tzdata 2020d-1.el8 -> 2020f-1.el8
* pivot://quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:4c5b83a192734ad6aa33da798f51b4b7ebe0f633ed63d53867a0c3fb73993024
              CustomOrigin: Managed by machine-config-operator
                   Version: 46.82.202012051820-0 (2020-12-05T18:24:10Z)
                    Commit: 7e014b64b96536487eb3701fa4f0e604697730bde2f2f9034c4f56c024c67119
  ...
  pivot://quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:47e1213c98063dfd7f5ccae41e611a25446c8ac493cfdd05d8f1c46b61ab13d4
              CustomOrigin: Managed by machine-config-operator
                   Version: 46.82.202011061621-0 (2020-11-06T16:25:16Z)
                    Commit: 944e410d59634e95ebffd364b148a1ac4008b1d323459f37cbca97d689722366
                            |- art-rhaos-4.4 (2020-11-06T09:52:14Z)
                            |- art-rhaos-4.5 (2020-11-06T16:12:30Z)
                            |- art-rhaos-4.6 (2020-11-06T15:04:39Z)
                            |- rhel8-fast-datapath (2020-10-15T21:50:55Z)
                            |- rhel8-baseos (2020-11-05T08:50:36Z)
                            `- rhel8-appstream (2020-11-05T08:45:53Z)
                 StateRoot: rhcos
